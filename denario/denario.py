...
# Optional import for cmbagent
try:
    import cmbagent
    # preprocess_task doesn't exist in current cmbagent version
    # It may have been removed or renamed
    preprocess_task = None
    CMBAGENT_AVAILABLE = True
    PREPROCESS_TASK_AVAILABLE = False
except ImportError:
    cmbagent = None
    preprocess_task = None
...
class Denario:
    ...
    def enhance_data_description(self,
        ...
        if not PREPROCESS_TASK_AVAILABLE:
            raise NotImplementedError(
                "preprocess_task is not available in the current version of cmbagent.\n"
                "The enhance_data_description() function requires preprocess_task which may have been removed or renamed.\n"
                "Please check the cmbagent documentation for the correct function to use, or skip this enhancement step."
            )
